...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 40999 or testnet: 50999)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 41000 or testnet: 51000)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Hancoin Wiki for SSL setup instructions)") + "\n" +
